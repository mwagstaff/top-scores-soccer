...
- **Cross:** when **CROSS** appears in a wide attacking position near the opposition box, keep running and hold ACTION. The cross aims towards attackers in the box automatically, even with the joystick still pointing along the wing. Release in the green band for a well-weighted delivery: too little power falls short, and too much can sail beyond your runners. A short tap still passes. Crossing position affects delivery quality, with better midfielders and attackers producing more accurate crosses. After release, the receiver runs to meet the cross; change the stick direction to adjust his run yourself.
- **Head:** attackers run to meet your cross. Tap ACTION as the ball reaches one to attempt a header towards goal automatically. Contact distance, height and tap timing affect the finish; better strikers are more accurate. For other reachable aerial balls, aim the joystick and tap when **HEAD** appears to head in that direction. A brief early tap prepares the header, but a tap near contact gives the best chance from a cross. Contact must happen at heading height and within reach; a completed header has a hop and light haptic feedback. High balls travel over players who cannot reach them, while opposition players can head descending balls. Headers follow the same offside involvement rules.
